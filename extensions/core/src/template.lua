...
function template.parsetemplate(view, context, key)
    assert(view, "view was not provided for template.parsetemplate(view, context, key).")
    return template.compile(view, key, true)(context)
end
